<template>
    <div>
        ...
        <h1 class="text-2xl font-bold mb-4">Create Check-Up</h1>
        <Form
            ref="formRef"
            :fields="[
                ...
                { key: 'services', label: 'Services', type: 'multi-select', options: services, labelKey: 'name', valueKey: 'id', placeholder: 'Select services', size: 'full' },
...
export default {
    ...
    setup() {
        ...
        const handleCreate = (data) => {
            Inertia.post('/dashboard/check-up', data);
        };
